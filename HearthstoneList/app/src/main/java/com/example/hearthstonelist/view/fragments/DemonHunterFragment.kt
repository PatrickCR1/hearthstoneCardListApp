...
import com.example.hearthstonelist.databinding.FragmentDemonHunterBinding
...
class DemonHunterFragment : Fragment() {
    ...
    private var _binding: FragmentDemonHunterBinding? = null
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, b: Bundle?): View? {
        ...
        _binding = FragmentDemonHunterBinding.inflate(inflater, container, false)
