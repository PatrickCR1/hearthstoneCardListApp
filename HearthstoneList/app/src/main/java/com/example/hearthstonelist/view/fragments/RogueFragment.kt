...
import com.example.hearthstonelist.databinding.FragmentRogueBinding
...
class RogueFragment : Fragment() {
    ...
    private var _binding: FragmentRogueBinding? = null
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, b: Bundle?): View? {
        ...
        _binding = FragmentRogueBinding.inflate(inflater, container, false)
