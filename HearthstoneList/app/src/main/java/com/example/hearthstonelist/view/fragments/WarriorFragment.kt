...
import com.example.hearthstonelist.databinding.FragmentWarriorBinding
...
class WarriorFragment : Fragment() {

    // ViewModel & Binding
    private lateinit var viewModel: CardListViewModel
    private var _binding: FragmentWarriorBinding? = null
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, b: Bundle?): View? {
        ...
        _binding = FragmentWarriorBinding.inflate(inflater, container, false)
