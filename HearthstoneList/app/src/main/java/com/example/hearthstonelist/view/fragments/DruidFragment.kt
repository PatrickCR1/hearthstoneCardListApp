...
import com.example.hearthstonelist.databinding.FragmentDruidBinding
...
class DruidFragment : Fragment() {
    ...
    private var _binding: FragmentDruidBinding? = null
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, b: Bundle?): View? {
        ...
        _binding = FragmentDruidBinding.inflate(inflater, container, false)
