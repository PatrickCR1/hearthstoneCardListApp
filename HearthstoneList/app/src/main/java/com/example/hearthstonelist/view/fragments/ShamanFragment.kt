...
import com.example.hearthstonelist.databinding.FragmentShamanBinding
...
class ShamanFragment : Fragment() {
    ...
    private var _binding: FragmentShamanBinding? = null
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, b: Bundle?): View? {
        ...
        _binding = FragmentShamanBinding.inflate(inflater, container, false)
