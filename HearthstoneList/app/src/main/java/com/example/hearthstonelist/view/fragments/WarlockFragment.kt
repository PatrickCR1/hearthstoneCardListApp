...
import com.example.hearthstonelist.databinding.FragmentWarlockBinding
...
class WarlockFragment : Fragment() {
    ...
    private var _binding: FragmentWarlockBinding? = null
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, b: Bundle?): View? {
        ...
        _binding = FragmentWarlockBinding.inflate(inflater, container, false)
