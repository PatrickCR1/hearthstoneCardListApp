...
import com.example.hearthstonelist.databinding.FragmentMageBinding
...
class MageFragment : Fragment() {
    ...
    private var _binding: FragmentMageBinding? = null
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, b: Bundle?): View? {
        ...
        _binding = FragmentMageBinding.inflate(inflater, container, false)
