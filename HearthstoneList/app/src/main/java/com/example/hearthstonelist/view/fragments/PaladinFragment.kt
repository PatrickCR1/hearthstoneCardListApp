...
import com.example.hearthstonelist.databinding.FragmentPaladinBinding
...
class PaladinFragment : Fragment() {

    // ViewModel & Binding
    private lateinit var viewModel: CardListViewModel
    private var _binding: FragmentPaladinBinding? = null
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, b: Bundle?): View? {
        ...
        _binding = FragmentPaladinBinding.inflate(inflater, container, false)
