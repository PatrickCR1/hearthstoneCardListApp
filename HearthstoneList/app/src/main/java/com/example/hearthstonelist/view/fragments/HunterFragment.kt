...
import com.example.hearthstonelist.databinding.FragmentHunterBinding
...
class HunterFragment : Fragment() {
    ...
    private var _binding: FragmentHunterBinding? = null
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, b: Bundle?): View? {
        ...
        _binding = FragmentHunterBinding.inflate(inflater, container, false)
